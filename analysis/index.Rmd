...
trends.s = generate_strata_trends(ind.s)


ind.c = generate_cont_indices(mod)
trends.c = generate_cont_trend(ind.c)



```

detach("package:bbsBayes",unload = T)

graph the indices and map the trends
```{r}
plot_cont_indices(indices = ind.c$data_summary)
generate_map(trend = trends.s)
